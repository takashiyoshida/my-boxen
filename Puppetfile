...
github "chrome", "1.1.2"
github "launchbar", "1.0.4", :repo => "takashiyoshida/puppet-launchbar"
github "spamsieve", "1.0.7", :repo => "takashiyoshida/puppet-spamsieve"
github "superduper", "1.0.1", :repo => "takashiyoshida/puppet-superduper"
github "transmission", "1.0.2", :repo => "singuerinc/puppet-transmission"
github "transmit", "1.0.4", :repo => "takashiyoshida/puppet-transmit"
github "undercover", "1.0.4", :repo => "takashiyoshida/puppet-undercover"
github "vlc", "1.1.0"
